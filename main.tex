...
%%
\fachbereich{department VII } 
\studiengang{Energy and Automation Systems}
\autor{Emile Schons 903606}
%\edvnr{123 456}
\titel{Projekt-Labor: Automatisierungstechnik } 
\untertitel{\textbf{Development and validation of a SoC algorithm for the charge controller mppt-1210-hus by libre.solar with lead acid battery}}
\betreuerFeld{
  \begin{tabular}{lr}
    \multicolumn{2}{l}{\textbf{Examiner}}\\
    {IS}& Berlin University of Applied Sciences and Technology\\
    {MJ}& Libre.Solar
  \end{tabular}
}
