...
It is popular to combine any of the approaches introduced in \ref{chap:Introduction} with a kalman filter (KF) in order to reduce the influence of white (uncorrelated) noise in measurements and to combine voltage and current measurments known as sensor fusion. The second principle make the algorithms resistent %TODO resilient bad choosen 
model parameters.  %\cite{} a couple of papers making use of KF in combinations with different approaches. 
